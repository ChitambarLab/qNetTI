...
"""
This script infers the topology of a 5-qubit zero state via the mutal info characteristic matrix.
...
filepath = qnetti.mkdir("./data/", "ibm_expt_zero_state_mi_char_shot_dependence/")
...
fig.suptitle("Mutual Info Inference of " + str(num_qubits) + "-Qubit zero state")
plt.legend()
