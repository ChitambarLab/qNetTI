...
"""
This script infers the topology of a 5-qubit ghz state via the mutal info characteristic matrix.
...
filepath = qnetti.mkdir("./data/", "ibm_expt_ghz_state_mi_char_shot_dependence/")
