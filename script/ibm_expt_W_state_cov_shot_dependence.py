...
"""
This script infers the topology of a 2-qubit ghz state and a 3-qubit W state.
...
ghz_prep_node = qnetvo.PrepareNode(wires=wires, ansatz_fn=qnetvo.ghz_state)

qnode_kwargs = {"diff_method": "parameter-shift"}
filepath = qnetti.mkdir("./data/", "ibm_expt_W_state_cov_shot_dependence/")
...
plt.title("Covariance Inference of W state and 2-Qubit GHZ state")
plt.legend()
