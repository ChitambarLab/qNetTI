...
```
python script/infer_ibm_network_W_state_shot_dependence.py cov 2 data/ibm_inference_W_state_5-qubit_ghz_state_shot_dependence/shots_1000/cov/tmp/ibmq_qasm_simulator_<date_time>.json
```
"""
