...
```
python script/infer_ibm_network_zero_state_shot_dependence.py cov 2 data/ibm_inference_5-qubit_zero_state_shot_dependence/shots_1000/cov/tmp/ibmq_qasm_simulator_<date_time>.json
```
"""
...
if sys.argv[1] == "cov":
    ...
    kwargs["num_vn_steps"] = 30
    kwargs["vn_init_json"] = init_json
elif sys.argv[1] == "mi":
    kwargs["num_mi_steps"] = 10
    kwargs["mi_init_json"] = init_json
elif sys.argv[1] == "mmi":
    kwargs["num_mmi_steps"] = 10
