...
"""
This script infers the topology of a 2-qubit GHZ state and 3-qubit W-state via the mutal info characteristic matrix.
...
filepath = qnetti.mkdir("./data/", "ibm_expt_W_state_mi_char_shot_dependence/")
...
for shots in shots_list:
    ...
    char_mat, mi_opt_dict, vn_opt_dict = qnetti.optimize_characteristic_matrix(
        qnetvo.PrepareNode(wires=wires, ansatz_fn=prep_circ),
...
fig.suptitle("Mutual Info Inference of W state")
plt.legend()
...
ax2.set_title("Mutual Info Optimization")
