...
"""
This script infers the topology of a 5-qubit ghz state.
...
filepath = qnetti.mkdir("./data/", "ibm_expt_ghz_state_cov_shot_dependence/")
...
plt.title("Covariance Inferece of " + str(num_qubits) + "-Qubit GHZ state")
plt.legend()
